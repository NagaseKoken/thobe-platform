...
export default function WorkerProfilePage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    setEdited((prev) => prev && ({ ...prev, [name]: name === "age" ? Number(value) : value }));
  };
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            <button
              ...
              className={`inline-flex items-center px-4 py-2 rounded-md font-medium ${
                isEditing ? "bg-green-600 text-white hover:bg-green-700" : "bg-orange-500 text-white hover:bg-orange-600"
              }`}
            >
              {isEditing ? "Save Changes" : <><PencilSquareIcon className="w-4 h-4 mr-2" />Edit Profile</>}
            </button>
          </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-500 mb-1 flex items-center">
                        <BuildingStorefrontIcon className="w-4 h-4 mr-1" /> Store Name
                      </label>
                      {isEditing ? (
                        <input
                          name="storeName"
